...
window.onblur = () => {
    timer = setTimeout (() => {
        changeTitle('https://img.icons8.com/windows/344/lock.png', 'Вернись - или заберу все деньги с карты');
    }, 3000)
}

window.onfocus = () => {
    clearTimeout(timer);
    changeTitle('https://img.icons8.com/windows/344/checkmark--v1.png', titleOld);
}